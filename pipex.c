...
/*   Updated: 2024/01/23 19:44:05 by denizozd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Opens the input file (0777 grants read, write, and execute permissions to the owner, group, and others),
duplicates/redirects standard input (0 for STDIN_FILENO) to the file,
duplicates/redirects standard output (1 for STDOUT_FILENO) to the writing end of the pipe,
...
Opens the output file with write-only mode, creates the file if it does not exist, truncates the file to zero length if it exists,
